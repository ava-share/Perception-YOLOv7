...
weights="/home/avalocal/catkin_ws/src/YOLOv7_ROS/src/yolov7/yolov7_Resnet50best.pt"
...
class detect():
    ...
    def __init__(self):
        ...
        self.image_sub = rospy.Subscriber("/camera_fr/image_color", Image, self.camera_callback, queue_size=1) #"/camera_fr/image_raw"
        rospy.spin()
